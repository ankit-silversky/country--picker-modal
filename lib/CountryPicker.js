...
export const CountryPicker = (props) => {
    ...
    globalPlaceHolder = flagProp.placeholder;
    useEffect(() => {
...
CountryPicker.defaultProps = {
    ...
    placeholder: <Text style={{fontFamily:
        Platform.OS === 'android'
          ? 'AvenirNextRoundedPro-Reg_0'
            : 'AvenirNextRoundedPro-Reg',
    color:'#686868'}}>{globalPlaceHolder}</Text>,
};
